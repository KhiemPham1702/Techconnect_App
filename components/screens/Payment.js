    ...
    function Order() {
        ...
        if (Address != undefined) {
            ...
            //// Pay by Credit Card ////
                ...
                alert("Currently, System still not support!")
            }
            else {
        ...
        if (temp != undefined) {
            ...
            for(let i = 0; i < temp.length; i++) {
                if (temp[i].Type == "Free Ship") {
                    ship = OriginValue.ShipFee - OriginValue.ShipFee * temp[i].ratio / 100
                }
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View flexDirection='row' marginLeft={30} marginTop={20}>
                    ...
                    <View marginLeft={10} width={270}>
                        ...
                        <Text style={styles.user} marginTop={2}>{address}</Text>
                    </View>
                    <Icon3 name='chevron-right' size={40} color={color.white}
                        marginTop={20} marginLeft={15}
                        onPress={() => navigation.navigate('New_address', {
                            address: Address,
                ...
                <View style={styles.pay_choose} marginTop={21}>
                    ...
                    <View flexDirection='row'>
                        ...
                        <View marginLeft={100}>
                            <Text style={styles.section} marginLeft={0} marginTop={10} textAlign='right'>${ShipFee}</Text>
                            <Text style={styles.section} marginLeft={0} marginTop={10} textAlign='right'>${Sum}</Text>
                            <Text style={styles.section2} marginLeft={0} marginTop={10} textAlign='right'>${Total}</Text>
                        </View>
                    </View>
                </View>
